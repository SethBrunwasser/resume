...
\section{Education}
  \resumeSubHeadingListStart
    \resumeEducation
      {Arizona State University, Tempe, AZ}{Expected May 2020}
...
\section{Projects}
  \resumeSubHeadingListStart
  	\resumeProject{PrivaCV}{Personal, 2018}{Python}
    	\resumeItemListStart
        	\resumeItem{PrivaCV is a security application that turns off the computer display when an unauthorized user is in view}
            \resumeItem{Used LBPH feature vector to dynamically update model with live face data}
        \resumeItemListEnd
    ...
    \resumeProject{Amazon Echo Mortal Kombat}{Southwest Hacks, 2017}{Python}
        \resumeItemListStart
            ...
            \resumeItem{Built and hosted Alexa Skill on Amazona Web Services}
        \resumeItemListEnd
  \resumeSubHeadingListEnd
